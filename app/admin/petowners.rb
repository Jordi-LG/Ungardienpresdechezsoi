ActiveAdmin.register Petowner do
  ...
  #
  # permit_params do
  #   permitted = [:email, :encrypted_password, :reset_password_token, :reset_password_sent_at, :remember_created_at, :first_name, :last_name, :describe, :age, :phone_number, :district_id]
