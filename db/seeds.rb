...
100.times do
  Comment.create(title: Faker::Book.title, content: Faker::Lorem.sentence(word_count: 20), petowner_id: rand(1..5), ps_id: rand(1..5))
end

puts "Comments created"

20.times do
  Petsitting.create(petsitter_id: rand(1..5), petowner_id: rand(1..5))
end
